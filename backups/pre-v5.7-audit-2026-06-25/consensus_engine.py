...
class ConsensusEngine:
    ...
    def integrate_pydantic(self, analyst_results: Dict[str, Dict], task_type: str, symbol: str) -> "ConsensusResult":
        ...
        # Determine signal strength (5-tier) — 委派給 stock_analysis.score_to_5tier
        # v5.6 C1 完全 dedup：consensus_engine.py 不再有 5-tier 硬編碼
        from stock_analysis import score_to_5tier
        overall_score = raw_result["overall_score"]
        signal_strength = score_to_5tier(overall_score)
